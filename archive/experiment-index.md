...
| exp-002 | insight-observer | 2026-07-22 | Abandoned | Scaffolding before defining leaves tooling with nothing to apply it to — and a folder with no index row is invisible to the project that contains it | [lessons](../knowledge/lessons-learned/exp-002-insight-observer.md) — no code, notes, or commits existed to preserve | No |
